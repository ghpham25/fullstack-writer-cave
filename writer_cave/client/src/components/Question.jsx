...
export default function Header() {
  ...
  //setting Prompt 
  const [textPrompt, setPrompt] = useState("hello")
  useEffect(() => {
  ...
  return (
    <>
      <div className="font-loader">
        {/* Question */}
        {
        !isPromptRevealed && (<div id="question" className="flex mt-2">
          <label
        ...
        <div id="answer">
          ...
          {isTextSubmitted && (
            <h2 className = " flex justify-center wrap text-white text-center font-bold text-3xl mt-10"> Thanks for sharing your thoughts today! Come back tomorrow for more prompts ~</h2>
          )}
        </div>
      </div>
    </>
